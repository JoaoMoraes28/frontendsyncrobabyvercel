        ...
        <div className="flex flex-col gap-5">
            ...
            xl:pb-10">
                <Markdown remarkPlugins={[remarkGfm]} components={{
                    h2: ({ node, ...props }) => <h2 className="font-poppins text-primary font-semibold text-xl mt-4" {...props} />,
                    h3: ({ node, ...props }) => <h3 className="font-poppins text-primary font-semibold text-lg mt-4" {...props} />,
                    p: ({ node, ...props }) => <p className="font-nunito text-primary-text mt-2" {...props} />,
                    ul: ({ node, ...props }) => <ul className="list-disc flex gap-2 mt-2 flex-col" {...props}  />
                }}>
